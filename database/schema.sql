...
CREATE TABLE IF NOT EXISTS activity_logs (
  ...
  type ENUM('Enquiry', 'RFQ', 'Dealer', 'Newsletter', 'CMS', 'Product', 'Blog', 'System') DEFAULT 'Enquiry',
  ...
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  CONSTRAINT fk_activity_logs_leads FOREIGN KEY (lead_id) REFERENCES leads(id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  type VARCHAR(100) NOT NULL DEFAULT 'Lead',
