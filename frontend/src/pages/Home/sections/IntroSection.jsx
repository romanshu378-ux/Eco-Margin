// EcoMargin Frontend — Dynamic Intro Section
...
export default function IntroSection() {
  ...
  const heading = homeData?.heroTitle ? `Who We Are — ${homeData.heroTitle}` : 'Who We Are'
  const subHeading = homeData?.heroSubtitle || 'EcoMargin bridges the gap between hardware manufacturers, operators, and EV drivers with a unified software ecosystem.'
  const desc = 'Born from the necessity of reliable infrastructure, we\'ve built the most advanced cloud-based charging station management system. Whether you operate a single charger at a retail store or a nationwide fast-charging network, EcoMargin scales effortlessly to meet your demands.'
