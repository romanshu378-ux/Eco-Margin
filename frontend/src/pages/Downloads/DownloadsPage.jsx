...
import { FiDownload, FiFileText, FiShield, FiCpu } from 'react-icons/fi'

const downloadsList = [
  {
    category: 'Product Technical Datasheets (PDF)',
    files: [
      { name: 'EcoWall 7.4kW AC Single Phase Charger Specification Sheet', size: '1.2 MB', type: 'PDF' },
      { name: 'EcoWall 22kW Dual Gun AC Charger Spec & CAD Drawing', size: '1.8 MB', type: 'PDF' },
      { name: 'EcoCharge 30kW DC Fast Charger Technical Manual', size: '2.5 MB', type: 'PDF' },
      { name: 'EcoCharge 60kW Dual CCS2 DC Charger Brochure & Wiring Diagram', size: '3.1 MB', type: 'PDF' },
      { name: 'EcoCharge 120kW / 160kW Ultra-Fast DC Station Specification', size: '4.2 MB', type: 'PDF' },
      { name: 'EcoCharge 240kW Heavy Duty Bus & Truck Charger Spec Sheet', size: '4.8 MB', type: 'PDF' }
    ]
  },
  {
    category: 'Certifications & Compliance Reports',
    files: [
      { name: 'ARAI Test Compliance Certificate (AIS 138 Part 1 & 2)', size: '2.1 MB', type: 'PDF' },
      { name: 'ISO 9001:2015 Quality Management System Certificate', size: '1.4 MB', type: 'PDF' },
      { name: 'CE Mark Electrical Safety Test Declaration', size: '1.1 MB', type: 'PDF' },
      { name: 'IP55 / IP65 Weatherproof & Ingress Protection Test Report', size: '2.9 MB', type: 'PDF' }
    ]
  },
  {
    category: 'Software & EPC Installation Guides',
    files: [
      { name: 'EcoMargin OCPP 2.0.1 Software Integration & API Guide', size: '3.5 MB', type: 'PDF' },
      { name: 'Civil & Electrical Site Preparation Guidelines for DC Fast Chargers', size: '5.0 MB', type: 'PDF' }
    ]
  }
]
